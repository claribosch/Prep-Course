...
function esEntero(numero) {
  ...
  // Tu código:
  if(numero >=0 && numero === Math.floor(numero)){return true;}
    else if (numero<0 && numero === Math.ceil(numero)){return true;}
    else{return false;}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí  
  let resultadoTabla = [] ;
  for(i=0;i<=10;i++){resultadoTabla.push(6*i);}
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  if (numero>0 && Math.floor(numero)>=100&&Math.floor(numero)<=999){return true;}
    if (numero<0 && Math.ceil(numero)<=-100&&Math.ceil(numero)>=-999){return true;}               
    else{return false;}}


function doWhile(numero) {
  //Implementar una función tal que vaya aumentando el valor recibido en 5 hasta un límite de 8 veces
  //Retornar elvalor final.
